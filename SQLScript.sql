...
WITH (FORMAT='CSV',FIRSTROW=2,CODEPAGE='65001');
GO
/* Imported As flat file and use script to insert values - bug with sql server */
...
/*========================
  Use flat file import for Order_Reviews because of sql server bug with BULK INSERT and NVARCHAR(MAX) columns.  Use script to insert values into Order_Reviews table.
